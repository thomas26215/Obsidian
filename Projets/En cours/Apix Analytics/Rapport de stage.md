...
APIX Analytics est une entreprise grenobloise spécialisée dans la conception, la fabrication et la commercialisation d'analyseurs de gaz chromatographiques industriels. Sa particularité tient à une intégration verticale complète : l'entreprise maîtrise à la fois le matériel — l'analyseur physique et son détecteur chromatographique — et le logiciel qui le pilote, l'ensemble de la suite PixL Suite étant développé en interne, depuis l'acquisition des signaux bruts jusqu'à la présentation des résultats. Ce développement conjoint du matériel et du logiciel par la même équipe constitue un atout différenciant : il permet une intégration poussée entre les deux et une grande réactivité pour adapter le logiciel aux évolutions de l'analyseur.
