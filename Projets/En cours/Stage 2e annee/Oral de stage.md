# Plan de l’oral de stage (20 minutes)

## 1. Introduction (2 minutes)

- Présentation rapide : nom, formation, établissement.
    
- Contexte du stage : 2e année de BUT Informatique à l’IUT2 de Grenoble, stage effectué chez Raynet du 14 avril au 4 juillet.
    
- Sujet principal : automatisation des tests logiciels Raypro, refonte du NameMapping, exploration de l’outil Image Based Action.
    
- Annonce du plan de l’exposé.
    

## 2. Présentation de l’entreprise Raynet (3 minutes)
...
- Présentation du logiciel Raypro et de son importance dans l’industrie.
    

## 3. Découverte et immersion (2 minutes)

- Description de la phase d’intégration : accueil, formation, découverte des équipes et des outils.
    
- Mention de la visite du musée ARhome et de l’intérêt de comprendre le contexte industriel.
    

## 4. Missions réalisées (8 minutes)

**A. Refonte du NameMapping (3 minutes)**

- Définition du NameMapping dans TestComplete.
    
- Raisons de la refonte et démarche suivie.
    
- Impact sur la fiabilité et la maintenance des tests.
    

**B. Automatisation des tests (3 minutes)**

- Présentation de TestComplete et de son utilisation.
    
- Création des tests automatisés : objectifs, méthodologie, exemples.
    
- Bénéfices obtenus.
    

**C. Exploration de l’Image Based Action (2 minutes)**

- Présentation de la fonctionnalité, intérêts et limites.
    
- Résultats des tests, avantages et inconvénients, restitution à l’équipe.
    

## 5. Compétences et apports du stage (2 minutes)

- Compétences techniques acquises : programmation, automatisation, gestion de versions, documentation.
    
- Compétences humaines : travail en équipe internationale, communication, autonomie.
    
- Apports du stage pour le projet professionnel.
    

## 6. Conclusion et perspectives (2 minutes)

- Bilan personnel : points forts du stage, éléments de fierté.
    
- Perspectives : influence de cette expérience sur la suite du parcours (études, carrière).
    
- Remerciements à l’équipe et aux encadrants.
    

---


## Script détaillé de l’oral de stage

---

## 1. Introduction

- Se présente : nom, étudiant en deuxième année de BUT Informatique à l’IUT2 de Grenoble.
    
- Précise la période du stage : du 14 avril au 4 juillet, au sein de l’entreprise Raynet.
    
- Explique le sujet principal du stage :
    
    - Automatisation des tests pour les logiciels industriels Raypro.
        
    - Refonte du NameMapping dans l’outil TestComplete.
        
    - Exploration de la fonctionnalité Image Based Action.
        
- Annonce le plan de la présentation :
...
- Raynet est une filiale du groupe ARaymond, créée en 2000 à Grenoble.
    
- Activités principales :
    
    - Développement de solutions logicielles pour l’industrie, notamment l’automobile.
        
    - Services de support informatique et cybersécurité.
        
    - Gestion de projets internationaux.
        
- Effectif d’environ 250 collaborateurs, chiffre d’affaires de 54 millions d’euros, 80% à l’export.
    
- Valeurs fondamentales : innovation, collaboration, respect, engagement envers la qualité.
    
- Présentation du logiciel Raypro :
    
    - Logiciel phare de Raynet, utilisé pour la simulation, la gestion et l’optimisation des processus de production industrielle.
        
    - Outil essentiel pour les clients industriels dans la gestion de la chaîne de production.
...
- Intégration au sein de l’entreprise :
    ...
    - Accueil par le tuteur et présentation de l’équipe projet.
        
    - Formation sur les outils internes, notamment TestComplete et Raypro.
        
- Découverte de l’environnement de travail :
    
    - Participation à des réunions d’équipe.
        
    - Utilisation des plateformes collaboratives et des outils de gestion de version.
        
- Visite du musée ARhome :
    
    - Découverte de l’histoire du groupe ARaymond.
        
    - Compréhension de l’évolution des besoins industriels et de l’importance de l’innovation logicielle.
        
- Importance de cette phase pour comprendre les enjeux du projet et s’intégrer dans la culture d’entreprise.
...
- Utilisation de l’outil TestComplete pour automatiser les tests fonctionnels du logiciel Raypro.
    
- Étapes de la mission :
    
    - Identification des scénarios de test prioritaires, en collaboration avec les développeurs et le support qualité.
        
    - Rédaction des cas de test détaillés.
        
    - Implémentation des scripts de test automatisés.
        
    - Exécution régulière des tests pour valider les nouvelles versions du logiciel.
        
- Bénéfices constatés :
    
    - Détection plus rapide des anomalies et des régressions.
        
    - Gain de temps significatif pour l’équipe de développement.
        
    - Amélioration de la traçabilité et de la documentation des tests.
        

## B. Refonte du NameMapping

- Le NameMapping dans TestComplete permet d’identifier et de référencer les objets graphiques des applications à tester.
    
- Constat initial :
    
    - Structure du NameMapping devenue complexe au fil du temps.
        
    - Difficultés pour retrouver et maintenir les objets lors de la création de nouveaux tests.
        
- Démarche suivie :
    
    - Analyse de l’existant et identification des points faibles.
        
    - Proposition d’une nouvelle organisation plus claire et hiérarchisée.
        
    - Validation de la nouvelle structure avec l’équipe de développement.
        
- Résultats :
    
    - Simplification de la maintenance des tests.
        
    - Meilleure fiabilité lors de l’exécution des tests automatisés.
        
    - Documentation de la nouvelle organisation pour faciliter la prise en main par d’autres membres de l’équipe.
        

## C. Exploration de l’Image Based Action

- Découverte de la fonctionnalité “Image Based Action” dans TestComplete :
    
    - Permet de créer des tests basés sur la reconnaissance d’images, utile lorsque les objets ne sont pas accessibles via les méthodes classiques.
        
- Réalisation de plusieurs tests pour évaluer la pertinence de cette approche :
    
    - Comparaison avec les méthodes traditionnelles d’automatisation.
        
    - Identification des avantages : flexibilité, adaptation à certains cas complexes.
        
    - Identification des limites : sensibilité aux modifications graphiques, maintenance plus délicate.
        
- Présentation des résultats de cette exploration à l’équipe :
    
    - Recommandations sur les cas d’usage appropriés pour l’Image Based Action.
...
- Compétences techniques développées :
    ...
    - Maîtrise des outils d’automatisation de tests (TestComplete).
        
    - Programmation de scripts de test, gestion de versions avec Git.
        
    - Rédaction de documentation technique.
        
- Compétences humaines et organisationnelles :
    
    - Travail en équipe internationale et communication en anglais.
        
    - Autonomie dans la gestion des missions et des priorités.
        
    - Capacité à présenter et à expliquer des choix techniques à l’équipe.
        
- Apport du stage pour le projet professionnel :
    
    - Découverte concrète des métiers liés à la qualité logicielle et à l’automatisation des tests.
        
    - Confirmation de l’intérêt pour ce domaine et envie de poursuivre dans cette voie.
...
- Bilan personnel :
    ...
    - Expérience très enrichissante sur le plan technique et humain.
        
    - Fierté d’avoir contribué à l’amélioration de la qualité des logiciels Raynet.
        
    - Satisfaction d’avoir mené à bien l’automatisation des tests et la refonte du NameMapping.
        
- Perspectives pour la suite :
    
    - Volonté de poursuivre dans le domaine du développement logiciel et de la qualité.
        
    - Projet de continuer à se former sur les outils d’automatisation et les bonnes pratiques du test logiciel.
